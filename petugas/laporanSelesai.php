 ...
 if ($_SESSION['login']==='admin') {
	...
	$query = "SELECT m.nama as nama_pengadu, p.tgl_pengaduan as tanggal_pengadu, p.isi_laporan as isi_pengaduan, p.foto as foto_pengaduan, p.status as status_pengaduan FROM pangaduan p JOIN masyarakat m where p.status ='selesai' AND p.nik = m.nik";
